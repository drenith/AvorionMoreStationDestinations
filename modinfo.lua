...
meta =
{
    ...
    name = "MoreStationDestinations",

    -- Title of your mod that will be displayed to players
    title = "MoreStationDestinations",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This increases the number of station supply sources + destinations to 9. This is a client only mod as the server already handles more than 3, but other users will be unable to see the additional options without this mod.",
